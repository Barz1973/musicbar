...
class Index extends Component
{
    ...
    public function addMusic()
    {
        ...
        return redirect('/my-music-bar')->with('message', 'Music added to playlist');
    ...
    public function update()
    {
        ...
        $this->reset();
        return redirect('/my-music-bar')->with('message', 'Music updated successfully.');
    }
    ...
    public function deleteMusic()
    {
        ...
        return redirect('/my-music-bar')->with('message', 'Music is deleted successfully');
    }
